...
function Date(_a) {
    ...
    return (_jsxs("div", Object.assign({}, filterDOMProps(props), { children: [label && _jsx("label", Object.assign({ htmlFor: id }, { children: label })), _jsx("input", { disabled: disabled, id: id, max: dateFormat(max), min: dateFormat(min), name: name, onChange: event => {
